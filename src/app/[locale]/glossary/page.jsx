// app/[locale]/coin-glossary/page.jsx  →  SERVER COMPONENT (SEO Layer)
...
const META = {
  en: {
    title:       "Crypto Coin Glossary – All Cryptocurrencies & Tokens 2025",
  ...
  ur: {
    title:       "کرپٹو کوائن گلاسری – تمام کریپٹو کرنسیز اور ٹوکنز 2025",
  ...
  ar: {
    title:       "قاموس العملات المشفرة – جميع العملات والرموز 2025",
  ...
  es: {
    title:       "Glosario de Criptomonedas – Todas las Monedas y Tokens 2025",
  ...
  fr: {
    title:       "Glossaire Crypto – Toutes les Cryptomonnaies et Tokens 2025",
  ...
  de: {
    title:       "Krypto-Glossar – Alle Kryptowährungen und Token 2025",
...
export async function generateMetadata({ params }) {
  ...
  const pageImage    = `${BASE_URL}/og-image-glossary`;

  const alternateLanguages = SUPPORTED_LOCALES.reduce((acc, lang) => {
    acc[lang] = `${BASE_URL}/${lang}/glossary`;
    return acc;
  }, {});
...
export default async function Page({ params }) {
  ...
  const collectionPageSchema = {
    ...
    image: {
      "@type":  "ImageObject",
      url:      `${BASE_URL}/og-image-glossary.jpg`,
      width:    1200,
      height:   630,
    },
  };
